...
<p align="center">
  <a href="https://www.nerdswhofish.com">
    <img src="assets/nwf-logo-dark.svg" alt="Nerds Who Fish" width="760">
  </a>
</p>
...
<table>
  <tr>
    <td width="50%" valign="top">
      ...
      <p>Self-hosted, parent-curated YouTube for kids. Children get the familiar experience, while parents control which channels they can watch.</p>
      <p><code>Go</code> <code>Swift</code> <code>TypeScript</code></p>
    </td>
    <td width="50%" valign="top">
      <h3><a href="https://github.com/NerdsWhoFish/dusk">Dusk</a></h3>
      <p>A Git-backed developer platform that gives homelabbers and their agents one place to understand, remember, and safely operate the whole estate.</p>
      <p><code>Go</code> <code>SQLite</code> <code>OpenTelemetry</code></p>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top">
      <h3><a href="https://github.com/NerdsWhoFish/bookings">Bookings</a></h3>
      <p>A small, themeable Google Calendar scheduling service. It handles conflicts and double-booking without a permanent server or reminder machine.</p>
      <p><code>Go</code> <code>TypeScript</code> <code>Cloud Run</code></p>
    </td>
    <td width="50%" valign="top">
      <h3><a href="https://github.com/NerdsWhoFish/trailwire">Trailwire</a></h3>
      <p>A local coordination bus for AI coding agents working across Claude Code, Codex, and Cursor. It keeps parallel work from quietly colliding.</p>
      <p><code>Go</code> <code>MCP</code> <code>SQLite</code></p>
    </td>
  </tr>
</table>
